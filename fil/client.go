...
func LotusAPIClientV1(ctx context.Context, url string, timeoutSecs int, bearerToken string) (*lotusapi.FullNodeStruct, jsonrpc.ClientCloser, error) { //nolint:revive
	if timeoutSecs == 0 {
		timeoutSecs = 30
	}
	hdr := make(http.Header, 1)
